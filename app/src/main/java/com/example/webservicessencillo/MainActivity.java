...
RequestQueue requestQueue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buscar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buscarUsuarios("http://192.168.1.72/ejemplo/select.php?id="+e8.getText()+"");
            }
        });
    }
    ...
    public void validar(View v){
        ...
        String url="http://192.168.1.72/ejemplo/insert.php?nombre="+nombre+"&apellido="+apellido+"&edad="+direccion+"&sexo="+telefono;
